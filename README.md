...
We have the simulation file sim-full-model.py similar to model0.py, model1.py, and model2.py 
This would be useful for building a financial app, together with the app-full-model.py
