...
And selection.py is the short file where we add spread to factors of normalized US stock geometric returns: We check which version of spread has the best predictive value: spread of rates, spread of log rates, log spread of rates, log spread of log rates. We first run the main file check-full-model.py and then apply this file selection.py
