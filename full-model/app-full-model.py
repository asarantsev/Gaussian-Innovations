...
def setupText(initialWealth, initialFlow, growthFlow, timeHorizon, bondShare0, bondShare1, intlShare, emShare, trShare):
    ...
    intlText = 'and ' + percent(intlShare) + ' International'
    devText = 'Intl Stocks: ' + percent(1 - emShare) + ' ex-US Developed MSCI EAFE 88% + Canada 12%'
    emText = 'and ' + percent(emShare) + ' Emerging MSCI'
    bondText = 'Bonds: ' + percent(1 - trShare) + ' BofA ICE Investment-Grade'
    trText = 'and ' + percent(trShare) + ' 10-year Treasury bonds'
    ...
    texts = [simText, usText, intlText, initText, devText, emText, bondText, trText, startText, endText, timeText, initWealthText, initialFlowText, growthText]
...
def output(simReturns, initialW, initialFlow, growthFlow, timeHorizon, bondStart, bondEnd, intlShare, emShare, trShare, fileName):
    ...
    SetupText = setupText(initialW, initialFlow, growthFlow, timeHorizon, bondStart, bondEnd, intlShare, emShare, trShare)
